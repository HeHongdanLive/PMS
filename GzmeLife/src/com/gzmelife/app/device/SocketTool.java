...
public class SocketTool {
    ...
    /** socket发送数据且接收数据 */
    public byte[] sendMessage_原版(final byte[] msg) {
            ...
            case (byte) 0xF5: // 下传文件
                ...
                if (buf[4] == 0x00) { // 发送文件大小和文件名，得到确认
                    ...
                    if (receiver != null) {
                        ...
                        System.out.println("HHD收到PMS返回确认上传菜谱文件完毕报文（Config.isF5=false）=" + Config.isF5);
                    ...
                    Config.cancelTransmit = false;
                    System.out.println("HHD收到PMS返回取消上传文件报文");
                    Config.isF5 = false;/** 非向PMS传送菜谱 */
                    System.out.println("HHD收到PMS返回取消上传菜谱文件报文（Config.isF5=false）=" + Config.isF5);
                }
                break;
            case (byte) 0xF6:
                if (buf[4] == (byte) 0x00) {
...
//                            System.out.println("请求发送心跳包");
     ...
     */
    private void upFile_原来(byte[] buf/* , int num */) {
